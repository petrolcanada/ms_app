...
const buildGlow = (color) =>
  `inset 0 1px 0 rgba(255,255,255,0.22), 0 0 18px ${color === 'var(--red)' ? 'rgba(255, 98, 122, 0.32)' : color}`;
                        ...
                        sx={{
                          ...
                          ...(value != null && value < 0
                            ? {
                                ...
                                background: `linear-gradient(90deg, ${barColor}, rgba(255,255,255,0.18))`,
                              }
                            : {
                                left: '50%',
